...
class OrgRelatedCache(Cache):
    ...
    def get_current_org(self):
        """
        Обратные вызовы, открытые для подклассов, которые контролируют организацию
         1. Возможность управления организацией в интерактивной среде
         2. Может контролировать организацию под задачей celery
        """
    ...
    def refresh_async(self, *fields):
        """
        Отправьте сигнал после фиксации транзакции, чтобы предотвратить получение последних данных из-за изоляции транзакции.
        """
        def func():
